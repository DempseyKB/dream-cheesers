export const metadata = {
  title: 'Menagerie - Dream Cheesers',
  description: 'Menagerie from the Dream Cheesers podcast',
};
    ...
    <div className="min-h-screen bg-dream-navy">
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-dream-cream mb-4">Menagerie</h1>
        ...
        <div className="page-content rounded-xl shadow-lg p-8">
          <p className="text-dream-cream/80 text-center text-lg">
            Coming soon! Check back later for the Menagerie from the Dream Cheesers podcast.
          </p>
        </div>
      </div>
    </div>
