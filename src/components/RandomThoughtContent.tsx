...
export function renderRichTextContent(content: any): React.ReactNode {
...
interface RandomThoughtContentProps {
  randomThought: RandomThoughtsType;
  episodeContext?: string;
}

export const RandomThoughtContent: React.FC<RandomThoughtContentProps> = ({ randomThought, episodeContext }) => {
  return (
